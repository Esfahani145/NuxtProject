<template>
    <v-card class="d-flex flex-column justify-space-between w-100 pa-6 rounded-2xl elevation-2 position-relative h-100 white-news-card">
        <div class="overflow-hidden rounded-lg mb-5">
            <v-img :src="item.image" height="180" cover alt="تصویر خبر" class="rounded-lg">
        ...
        <div class="d-flex flex-column flex-grow-1">
            <div class="d-flex align-center mb-4 font-weight-medium blue-grey--text text--darken-2">
                <div class="d-flex align-center ml-4">
                    <v-icon small color="span" class="ml-1 font-size-8">mdi-calendar-month-outline</v-icon>
                    <span>{{ item.date }}</span>
                </div>
        ...
        <div class="mt-auto">
            ...
            <div class="d-flex align-center justify-space-between">
                <div class="d-flex align-center font-weight-bold blue-grey--text text--darken-2">
                    <v-icon small color="span" class="ml-1 font-size-8">mdi-account-circle-outline</v-icon>
                    {{ item.auth }}
                </div>
                <BaseButton
                    color="primary"
